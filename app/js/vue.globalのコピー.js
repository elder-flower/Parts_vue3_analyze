var Vue = (function (exports) {
  ...
  /*
  * マップを作成し、キーがそのマップにあるかどうかを確認する関数を返します。
  * 重要: この関数のすべての呼び出しには、接頭辞を付ける必要があります。
  * \/\*＃\_\_ピュア\_\_\*\/
  *必要に応じて、ロールアップでそれらをツリーシェイクできるようにします。
  */
      ...
      const componentUpdateFn = () => {
        if (!instance.isMounted) {
          ...
          if (
            ...
            console.log('isAsyncWrapperVNode');

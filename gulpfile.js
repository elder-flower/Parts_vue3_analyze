...
const rev2 = require("gulp-rev-all");
...
function bs_watch3(done) {
  gulp.watch([paths.bld + "*.*.html"], series("reload"));
  done();
}
exports.watch = bs_watch3;
exports.b = parallel(bs_watch3, bs_sync);
